...
cmos_nand3: cmos_nand3.v cmos_nand3_tb.v cmos_and3.v cmos_and2.v cmos_inverter.v cmos_nand2.v
	iverilog -o $@ $^
	@echo "CMOS NAND3"
	vvp $@
...
cmos_nor3: cmos_nor3.v cmos_nor3_tb.v cmos_or3.v cmos_or2.v cmos_nor2.v cmos_inverter.v
	iverilog -o $@ $^
	@echo "CMOS NOR3"
	vvp $@

cmos_xor2: cmos_xor2.v cmos_xor2_tb.v cmos_nor2.v
	iverilog -o $@ $^
	@echo "CMOS XOR2"
	vvp $@
